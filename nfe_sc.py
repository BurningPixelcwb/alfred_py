...
purchased_item = nav.find_elements(libs.By.XPATH, '//table[@id="tabResult"]//tr/td[1]/span[@class="txtTit"]')

cod_productuto = nav.find_elements(libs.By.XPATH, '//table[@id="tabResult"]//tr/td[1]/span[@class="RCod"]')
...
for i in range(compras):
    #print(cod_productuto[i].text + " : " + purchased_item[i].text + " : " +  quantity[i].text + " : " +  measure[i].text + " : " + price[i].text + " : " + total_value[i].text)
